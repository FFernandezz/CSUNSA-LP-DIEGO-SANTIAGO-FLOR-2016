  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
       <!--barra derecha-->
          <button onclick="location.href= <?php echo "'".$loginUrl ."'";?>" id="logoFace"><img src="images/Log_facebook.png" widht="148" height="30"></button>
      </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview" ng-click="eventosPopulares()">
          <a href="#">
